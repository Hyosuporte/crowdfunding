        ...
        <div class="proyectosFila">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="botonCardDestacado">Ver Proyecto <img src="<?php echo BASE_URL; ?>Assets/img/Ojo.svg"
                            width="20" alt=""></button>
                </div>
            </div>
            <div class="card">
        ...
        <div class="bloqueSubirProyecto">
            <div class="subirFirstColumn">
                ...
                <ul>
                    ...
                    <div><a href="/Home/login/"><button class="botonBannerLanding" type="button">Subir Proyecto</button></a></div>
                </ul>
            </div>
