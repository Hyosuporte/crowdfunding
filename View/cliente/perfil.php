...
<div class="content">
    <div class="d-flex flex-row text-white ">
        ...
        <div class="list-group">
          <a href="#cuenta" class=" list-group-item-action active nav-link textoMenu" data-bs-toggle="tab"
            aria-selected="true" role="tab" onclick="aparecerVista('cuenta')"><img style="margin-right: 1vw;"
              src="<?php echo BASE_URL; ?>Assets/img/proyectosSubidosDashboard.svg" alt="">Proyectos subidos</a>
          <a href="#perfil" class=" list-group-item-action textoMenu" data-bs-toggle="tab" aria-selected="false"
            ...
            onclick="desaparecerVistas(['cuenta','v-pills-subir-proyecto-1','v-pills-subir-proyecto-2','v-pills-subir-proyecto-3'])"><img
              style="margin-right: 1vw;" src="<?php echo BASE_URL; ?>Assets/img/proyectosDonadosDashboard.svg" alt="">Proyectos
            Donados</a>
          <a href="#misProtectos" class=" list-group-item-action textoMenu" data-bs-toggle="tab" aria-selected="false"
            role="tab"
            onclick="desaparecerVistas(['cuenta','v-pills-subir-proyecto-1','v-pills-subir-proyecto-2','v-pills-subir-proyecto-3'])"><img
              style="margin-right: 1vw;" src="<?php echo BASE_URL; ?>Assets/img/actualizarDatosDashboard.svg" alt="">Actualización
            Datos</a>
          <a href="/Home/usuario/salir" class=" list-group-item-action textoMenuAbajo" data-bs-toggle="tab"
            aria-selected="false" role="tab"><img style="margin-right: 1vw;" src="<?php echo BASE_URL; ?>Assets/img/cerrarSesionDashboard.svg"
              alt="">Cerrar Sesión</a>
        </div>
      </div>
      <div class="col-10  tab-content bloqueDashboard panelDashboard" id="configPerfil">
        ...
        <div class="tab-pane fade  fondoDashboard" id="v-pills-subir-proyecto-1" role="tabpanel"
          aria-labelledby="v-pills-subir-proyecto-1" tabindex="0">
          <div class="contenido">
            <form action="">
              ...
              <input class="inputGrandeForm" type="text" name="nombre" id="nombre"
              ...
              <div class="grupoInputsForm">
                ...
                <input type="number" class="grupoInput1" placeholder="Telefono Responsable*" required id="telefono"
                  name="telefono" onkeydown="filtro()">
                <script>
                  function filtro() {
                    var tecla = event.key;
                    if (['.', 'e'].includes(tecla))
              ...
              <div class="list-group"><a href="#v-pills-subir-proyecto-2" class="botonForm" data-bs-toggle="tab"
                  aria-selected="false" role="tab"
                  onclick="desaparecerVista('v-pills-subir-proyecto-1'),aparecerVista('v-pills-subir-proyecto-2')">Subir
                  Proyecto</a></div>
            </form>
          </div>
        </div>
        <div class="tab-pane fade fondoDashboard" role="tabpanel1" id="v-pills-subir-proyecto-2">
          <div class="contenido">
            <form action="">
              ...
              <div class="grupoInputsForm">
                <input type="text" class="grupoInput1" placeholder="Palabras Clave**" required id="palabras"
                  name="palabras">
                <input type="number" class="grupoInput1" placeholder="Indicador Impacto*" required id="impacto"
                  name="impacto">
              </div>
              <textarea class="inputGrandeFormArea" name="resumen" id="resumen" cols="30" rows="5"
              ...
              <div class="list-group"><a href="#v-pills-subir-proyecto-3" class="botonForm" data-bs-toggle="tab"
                  aria-selected="false" role="tab"
                  onclick="desaparecerVista('v-pills-subir-proyecto-2'),aparecerVista('v-pills-subir-proyecto-3')">Subir
                  Proyecto</a></div>
            </form>
          </div>
        </div>
          ...
          <div class="contenido">
            <form action="">
              ...
              <div class="grupoInputsForm2 inputArchivo">
                ...
                <input class="inputFileForm" type="file" name="existenciaYrepresentacion"
                  id="existenciaYrepresentacion">
              </div>
              <div class="titulosInputsFileForm">
          ...
          <div class="container">
              ...
              <div class="col-md-6">
                <form id="frmUpdateCorreo">
                  <div class="form-group">
                    ...
                    <input id="newCorreo" class="form-control inputActualizarDatos" type="email" name="newCorreo"
            ...
            <form id="frmUpdatePassword">
              <div class="row flex-row">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <input id="passwordNow" class="form-control inputActualizarDatos" type="password" name="passwordNow"
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    <input id="newPassword" class="form-control inputActualizarDatos" type="password" name="newPassword"
                      placeholder="Nueva contraseña" />
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                    <input id="newPasswordTry" class="form-control inputActualizarDatos" type="password"
                      name="newPasswordTry" placeholder="Vuelve a escribir la contraseña" />
                  </div>
                </div>
              </div>
            </form>
          ...
          <div class="container">
            <form>
              ...
              <div class="row justify-content-center mt-4">
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="nombreCompleto" class="form-control inputActualizarDatos" type="text"
                      name="nombreCompleto" placeholder="Nombre Completo" />
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="correo" class="form-control inputActualizarDatos" type="email" name="correo" disabled
                      value="<?php echo $_SESSION['usuario']; ?>" placeholder="Dirrecion de Correo Electrónico" />
                  </div>
                </div>
              </div>
              <div class="row justify-content-center mt-4">
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="pais" class="form-control inputActualizarDatos" type="text" name="pais"
                      placeholder="Pais">
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="ciudad" class="form-control inputActualizarDatos" type="text" name="ciudad"
                      placeholder="Ciudad">
                  </div>
                </div>
              </div>
              <div class="row justify-content-center mt-4">
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="direccion" class="form-control inputActualizarDatos" type="text" name="direccion"
                      placeholder="Direccion">
                  </div>
                  <div>
                    <button type="button" class=" botonFormActualizar mt-3 mb-4">
                      Guardar Cambios
                    </button>
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                    <input id="telefono" class="form-control inputActualizarDatos" type="number" name="telefono"
