...
class proyecto extends Controller
{
    ...
    public function insertarproyecto()
    {
        ...
        $duracion_campana = strClean($_POST['comienzo']); //pendiente actualizar
    ...
    public function editarproyecto()
    {
        ...
        if (
            ...
            $data = $this->model->editarproyecto($camara, $RUT, $rep_legal, $cedula, $bancario, $aprob_donacion, $form_declaraciones, $keywords, $tiempo_ejecucion, $titulo, $foto, $duracion_campana, $fecha_comienzo, $fecha_final, $abstrac, $indicador, $monto, $video, $info_adicional);
            if ($data === "ok") {
