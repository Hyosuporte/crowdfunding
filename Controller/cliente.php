            ...
            if ($_SESSION['rol'] == 2) {
                ...
                for ($i = 0; $i < count($data); $i++) {
                    if ($data[$i]['estado'] == "Aprobado") {
                        ...
                        $data[$i]['camara_comercio'] = '<a href="' . BASE_URL . 'proyecto/downloadsArchivos?camara=' . $data[$i]['camara_comercio'] . '"><button class="boton" type="button"><i class="fa-solid fa-file-arrow-down"></i></button></a>';
