...
class proyectoDAO extends Query
{
  ...
  {
    $sql = "SELECT p.id_proyecto,p.titulo,p.foto,p.abstrac,p.monto_financiacion,COUNT(d.monto),SUM(d.monto),p.fecha_comienzo,p.fecha_final FROM proyecto p JOIN donacion d ON d.id_proyecto=p.id_proyecto WHERE p.id_proyecto='$id'";
